...
file_list = [
    ("data/training/v2/passive_without_be.ndjson", 500000, 5000),
    ("data/training/v2/passive_with_incorrect_be.ndjson", 200000, 1000),
    ("data/training/v2/passive_perfect_without_have.ndjson", 200000, 1000),
    ("data/training/v2/perfect_progressive_with_incorrect_be_and_without_have.ndjson", 200000, 1000),
    ("data/training/Perfect_progressive_without_have.ndjson", 200000, 1000),
    ("data/training/v2/perfect_without_have.ndjson", 500000, 5000),
    ("data/training/Simple_past_instead_of_past_perfect.ndjson", 200000, 1000),
    ("data/training/v2/its_versus_it's.ndjson", 50000, 1000),
    ...
    ("data/training/v2/subject_verb_agreement_with_personal_pronoun.ndjson", 500000, 5000),
    ("data/training/v2/subject_verb_agreement_with_simple_noun.ndjson", 500000, 5000),
    ("data/training/v2/subject_verb_agreement_with_indefinite_pronoun.ndjson", 500000, 5000),
    ...
    ("data/training/v2/possessive_pronouns.ndjson", 100000, 1000),
    ("data/training/v2/subject_pronouns.ndjson", 100000, 1000),
    ("data/training/v2/object_pronouns.ndjson", 200000, 1000),
    ("data/training/Their_vs._there_vs._they're.ndjson", 100000, 1000),
    ("data/training/Incorrect_participle.ndjson", 500000, 5000),
