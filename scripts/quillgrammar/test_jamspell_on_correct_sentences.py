...
whitelist = set() #set(wordfreq.top_n_list("en", 10000))
...
outputfile = "bea_spellcheck_correct_sentences.csv"
...
with open(outputfile, "w") as o:
    ...
    for instance in tqdm(instances[:10000]):
        sentence = instance[0]
        ...
        #corrected_sentence, corrections = correct_with_jamspell(detokenized_gold_sentence, [])
        corrected_sentence, response, output = correct_sentence_with_bing(detokenized_gold_sentence)
        #print(instance)
        #print(sentence)
        ...
        total += 1
        writer.writerow([detokenized_gold_sentence,
#                         "; ".join(corrections),
                         corrected_sentence,
                         str(response),
                         str(output)])
